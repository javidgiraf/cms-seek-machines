            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form  method="post" enctype="multipart/form-data" action="{{route('customers.update',encrypt($user->id))}}">
                                @csrf
                                @method('put')
                                <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                        @if((file_exists('storage/' . $user->customer->image_url)) && $user->customer->image_url!="")
                                        <input type="file" class="dropify" name="image_url" data-default-file="{{ asset('storage/' . $user->customer->image_url) }}">
                                        @else
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                        <div class="form-group">
                                            <select class="form-control" name="status">
                                                <option  selected disabled>--Please Select--</option>
                                                 <option value='1' {{($user->customer->status=='1')?'selected':''}}>Yes</option>
                                                 <option value='0' {{($user->customer->status=='0')?'selected':''}}>No</option>
