        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Create</strong> New Banner</h2>
                        ...
                        <div class="body">
                            <form method="post" enctype="multipart/form-data" action="{{route('banners.store')}}">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                        <div class="form-group">
                                            <input type="text" id="title" name="title" class="form-control" placeholder="Enter your Banner Title">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                        <div class="form-group">
                                            <input type="text" id="label" name="label" class="form-control" placeholder="Enter your Blog Label">
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                        <div class="form-group">
                                            <input type="text" id="link_to" name="link_to" class="form-control" placeholder="Enter Banner Link">
                                        </div>
                                    </div>
                                </div>
