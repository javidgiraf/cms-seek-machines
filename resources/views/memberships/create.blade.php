                        ...
                        <div class="body">
                            <form method="post" enctype="multipart/form-data" action="{{route('memberships.store')}}">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                        <div class="form-group">
                                            <input type="integer" id="pricing" name="pricing" class="form-control" placeholder="Enter your pricing">
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                        <div class="form-group">
                                            <input type="integer" id="no_of_month" name="no_of_month" class="form-control" placeholder="Enter your period (months)">
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
