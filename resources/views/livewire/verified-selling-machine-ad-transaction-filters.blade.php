          ...
          <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      @if((file_exists('storage/' . $transaction->sell_machine->default_image)) && $transaction->sell_machine->default_image!="")

                      <td><img src="{{ asset('storage/' . $transaction->sell_machine->default_image) }}"></td>
                      @else
                      <td><img src="{{asset('frontend/assets/images/no-image.png')}}" style="width:100px"></td>
                      @endif
                      <th>{{$transaction->sell_machine->title}}</th>
