        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Edit</strong> Seek Agent</h2>
                        </div>
                        <div class="body">
                            <form method="post" enctype="multipart/form-data" action="{{route('seekagent.update', $agent->id)}}">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="user_id" id="user_id">
                                                ...
                                                @foreach ($users as $user)
                                                    <option value="{{ $user->id }}" {{ $agent->user_id == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <div class="form-group">
                                            <input type="text" id="designation" name="designation" class="form-control" value="{{ old('designation', $agent->designation) }}" placeholder="Enter Designation">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <div class="form-group">
                                            <input type="number" id="phone" name="phone" class="form-control" value="{{ old('phone', $agent->phone) }}" placeholder="Enter customer phone">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        ...
                                        @if($agent->image_url!="")
                                        <input type="file" class="dropify" name="single_image_url" id="single_image_url" accept=".png,.jpeg,.jpg,.svg,.webp" data-default-file="{{ asset(config('app.image_root_url'). $agent->image_url) }}">
                                        @else
                                        ...
                                        <input type="hidden" id="image_url" name="image_url" value="{{$agent->image_url}}">
                                    </div>
                                </div>
                                <!-- Status Dropdown -->
                                <div class="row clearfix">
